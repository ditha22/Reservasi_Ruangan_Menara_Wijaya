...
<div class="dash-hero">
  <div class="dash-hero-inner">
    ...
    <div class="dash-sub"><?php echo e(\App\Services\DataService::formatDate(date('Y-m-d'))); ?></div>

    <div class="stats-grid">
      
      <a class="stat-link" href="<?php echo e(route('admin.bookings', ['filter' => 'semua'])); ?>">
        <div class="stat-card">
          <div class="stat-top">
            <span style="font-size:22px">📨</span>
            <span class="stat-pill pill-total">Total</span>
          </div>
          <div class="stat-card-num"><?php echo e($total); ?></div>
      ...
      <a class="stat-link" href="<?php echo e(route('admin.bookings', ['filter' => 'MENUNGGU'])); ?>">
        <div class="stat-card">
          <div class="stat-top">
            <span style="font-size:22px">⏳</span>
            <span class="stat-pill pill-pending"><?php echo e($pending); ?> pending</span>
          </div>
          <div class="stat-card-num"><?php echo e($pending); ?></div>
      ...
      <a class="stat-link" href="<?php echo e(route('admin.bookings', ['filter' => 'DISETUJUI'])); ?>">
        <div class="stat-card">
          <div class="stat-top">
            <span style="font-size:22px">✅</span>
            <span class="stat-pill pill-approved">Disetujui</span>
          </div>
          <div class="stat-card-num"><?php echo e($approved); ?></div>
      ...
      <a class="stat-link" href="<?php echo e(route('admin.bookings', ['filter' => 'DITOLAK'])); ?>">
        <div class="stat-card">
          <div class="stat-top">
            <span style="font-size:22px">❌</span>
            <span class="stat-pill pill-rejected">Ditolak</span>
          </div>
          <div class="stat-card-num"><?php echo e($rejected); ?></div>
      ...
      <a class="stat-link" href="<?php echo e(route('admin.bookings', ['filter' => 'DIBATALKAN'])); ?>">
        <div class="stat-card">
          <div class="stat-top">
            <span style="font-size:22px">🚫</span>
            <span class="stat-pill pill-canceled">Dibatalkan</span>
          </div>
          <div class="stat-card-num"><?php echo e($canceled ?? 0); ?></div>
...
<div class="dash-wrap">
  <div class="dash-actions">
    <a href="<?php echo e(route('admin.bookings')); ?>" class="dash-btn dash-btn-primary">📋 Kelola Semua Booking</a>
    <a href="<?php echo e(route('admin.laporan')); ?>" class="dash-btn dash-btn-ghost">📊 Laporan & Rekap</a>
    <a href="<?php echo e(route('admin.blackout')); ?>" class="dash-btn dash-btn-gray">🚧 Kelola Blackout</a>

    
    <a href="<?php echo e(route('admin.ruang.index')); ?>" class="dash-btn dash-btn-ghost">🏢 Kelola Ruangan</a>
    <a href="<?php echo e(route('admin.opd.index')); ?>" class="dash-btn dash-btn-gray">🏛️ Kelola OPD</a>
  </div>

  <div class="table-container">
    <div class="table-header">
      <span class="table-title">🕐 Aktivitas Terbaru</span>
      <a href="<?php echo e(route('admin.bookings')); ?>" class="filter-btn" style="color:var(--blue-600);border-color:var(--blue-200)">Lihat Semua →</a>
    </div>
      ...
      <table>
        ...
        <tbody>
          <?php $__empty_1 = true; $__currentLoopData = $recent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
              <td style="font-weight:600"><?php echo e(Str::limit($b->kegiatan, 40)); ?></td>
              <td><?php echo e($b->opd); ?></td>
              <td><?php echo e($b->room->nama ?? '—'); ?></td>
              <td><?php echo e($b->tanggal_formatted ?? '-'); ?></td>
              <td>
                <span class="badge badge-<?php echo e(strtolower($b->status)); ?>"><?php echo e($b->status); ?></span>
              </td>
              <td>
                <div class="td-actions">
                  <a href="<?php echo e(route('admin.booking.show', $b->kode)); ?>" class="btn-action btn-view">Detail</a>
                </div>
              </td>
            </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Project\Ruangan_Menara_Wijaya\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>