...
<div class="hero">
  ...
  <div class="hero-inner">
    <div class="hero-content" style="animation:slideUp 0.6s ease both">
      ...
      <div class="hero-cta">
        <a href="<?php echo e(route('kalender')); ?>" class="btn-hero-primary">🗓️ Lihat Kalender Ruangan</a>
        <a href="<?php echo e(route('agenda')); ?>" class="btn-hero-secondary">📋 Agenda Hari Ini</a>
      </div>

      <div class="hero-stats">
        <div class="hero-stat">
          <span class="hero-stat-num"><?php echo e($totalRuangan); ?></span>
          <span class="hero-stat-label">Ruangan</span>
        </div>
        <div class="hero-stat">
          <span class="hero-stat-num"><?php echo e($totalToday); ?></span>
    ...
    <div class="signage-card">
      ...
      <div class="signage-date-bar">
        ...
        <div class="signage-date-value"><?php echo e(\App\Services\DataService::formatDate(date('Y-m-d'))); ?></div>
        <div>📅</div>
      </div>
      ...
      <?php if(count($todayBookings) > 0): ?>
        <?php $__currentLoopData = $todayBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php $r = \App\Services\DataService::getRuanganById($b['ruang_id']); ?>
          <div class="signage-row">
            <div class="signage-col-ruang"><?php echo e($r ? $r['nama'] : '—'); ?></div>
            <div class="signage-col-jam"><?php echo e(\Carbon\Carbon::parse($b['jam_mulai'])->format('H.i')); ?></div>
            <div class="signage-col-acara"><?php echo e($b['kegiatan']); ?></div>
            <div class="signage-col-pelaksana"><?php echo e($b['opd']); ?></div>
          </div>
      ...
      <a href="<?php echo e(route('agenda')); ?>" class="signage-footer-btn">Lihat Semua Agenda Hari Ini →</a>
    </div>
  </div>
</div>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:24px">
      <?php $__currentLoopData = [
        ...
        <div style="text-align:center;padding:32px 24px;border-radius:16px;background:var(--blue-50);border:1px solid var(--blue-100)">
          <div style="width:64px;height:64px;background:linear-gradient(135deg,<?php echo e($step['color']); ?>);border-radius:18px;display:flex;align-items:center;justify-content:center;font-size:28px;margin:0 auto 20px"><?php echo e($step['icon']); ?></div>
          <h3 style="font-family:'Playfair Display',serif;font-size:20px;color:var(--blue-900);margin-bottom:10px"><?php echo e($step['num']); ?>. <?php echo e($step['title']); ?></h3>
          <p style="font-size:14px;color:var(--gray-500);line-height:1.6"><?php echo e($step['desc']); ?></p>
        </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
  </div>
...
<div class="section">
  <div class="section-inner" style="text-align:center">
    <div style="background:linear-gradient(135deg,var(--blue-800),var(--blue-600));border-radius:24px;padding:60px 40px;position:relative;overflow:hidden">
      ...
      <a href="<?php echo e(route('login')); ?>" class="btn-hero-primary" style="font-size:16px;padding:16px 36px;position:relative">Booking Sekarang →</a>
    </div>
  </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Project\Ruangan_Menara_Wijaya\resources\views/pages/home.blade.php ENDPATH**/ ?>