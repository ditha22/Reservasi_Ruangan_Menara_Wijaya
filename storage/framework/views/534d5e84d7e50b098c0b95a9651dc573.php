...
<title><?php echo $__env->yieldContent('title', 'Reservasi Ruangan'); ?> — Menara Wijaya</title>
...
<nav class="nav">
  <div class="nav-inner">
    ...
    <div class="nav-links">
      ...
      <a href="<?php echo e(route('agenda')); ?>" class="nav-link <?php echo e(request()->routeIs('agenda') ? 'active' : ''); ?>">Agenda Hari Ini</a>
      <a href="<?php echo e(route('kalender')); ?>" class="nav-link <?php echo e(request()->routeIs('kalender') ? 'active' : ''); ?>">Kalender & Ruangan</a>
      <?php if(session('role') === 'opd'): ?>
        <a href="<?php echo e(route('opd.bookings')); ?>" class="nav-link <?php echo e(request()->routeIs('opd.*') ? 'active' : ''); ?>">Booking Saya</a>
      <?php endif; ?>
      <?php if(session('role') === 'publik'): ?>
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.*') ? 'active' : ''); ?>">Dashboard Admin</a>
      <?php endif; ?>
    </div>
    ...
    <div class="nav-actions">
      ...
      <?php else: ?>
        <div class="nav-user">
          <div class="nav-user-avatar" style="<?php echo e(session('role')==='publik' ? 'background:linear-gradient(135deg,#7c3aed,#a78bfa)' : ''); ?>">
            <?php echo e(strtoupper(substr(session('user_name', 'A'), 0, 1))); ?>

          </div>
          <div>
            <div class="nav-user-name"><?php echo e(session('user_name')); ?></div>
            <div class="nav-user-role" style="<?php echo e(session('role')==='publik' ? 'color:#7c3aed' : ''); ?>">
              <?php echo e(session('role') === 'publik' ? 'Admin Publik' : 'Admin OPD'); ?>
...
<div class="mobile-menu" id="mobileMenu">
  ...
  <a href="<?php echo e(route('agenda')); ?>" class="nav-link">📅 Agenda Hari Ini</a>
  <a href="<?php echo e(route('kalender')); ?>" class="nav-link">🗓️ Kalender & Ruangan</a>

  
  <?php if(session('role') === 'opd'): ?>
    <a href="<?php echo e(route('opd.bookings')); ?>" class="nav-link">📄 Booking Saya</a>
  <?php endif; ?>

  <?php if(session('role') === 'publik'): ?>
    <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link">🛡️ Dashboard Admin</a>
  <?php endif; ?>
...
<div class="main-content">
  <?php if(session('success')): ?>
    <script>document.addEventListener('DOMContentLoaded',()=>showToast('<?php echo e(addslashes(session('success'))); ?>','success'));</script>
  <?php endif; ?>
  <?php if(session('error')): ?>
    <script>document.addEventListener('DOMContentLoaded',()=>showToast('<?php echo e(addslashes(session('error'))); ?>','error'));</script>
  <?php endif; ?>
...
</html><?php /**PATH C:\Project\Ruangan_Menara_Wijaya\resources\views/layouts/app.blade.php ENDPATH**/ ?>