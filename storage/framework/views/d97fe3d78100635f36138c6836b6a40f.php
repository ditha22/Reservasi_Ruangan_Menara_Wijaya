<?php $__env->startSection('title', 'Kalender Reservasi'); ?>
...
const isLoggedIn = <?php echo e(session('logged_in') ? 'true' : 'false'); ?>;
const userRole = '<?php echo e(session('role', '')); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Project\Ruangan_Menara_Wijaya\resources\views/pages/kalender.blade.php ENDPATH**/ ?>