  ...
  <div class="login-container fade-in">
    ...
    <div class="demo-mini" id="hintOpd">
      ...
      <div class="row">
        <p style="margin:0">
          Demo Admin OPD:
          username <span><?php echo e($demoOpdUsername); ?></span>
      ...
      <div class="demo-box" id="demoOpdBox">
        ...
        <div class="demo-list">
          ...
          <?php $__empty_1 = true; $__currentLoopData = $demoOpdUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>

            <div class="demo-item">
              <span class="demo-mono">
                <?php echo e($u->username); ?> / Opd12345
              </span>
    ...
    <div class="demo-mini" id="hintPublik" style="display:none">
      ...
      <div class="row">
        <p style="margin:0">
          Demo Admin Publik:
          username <span><?php echo e($demoPublikUsername); ?></span>
      ...
      <div class="demo-box" id="demoPublikBox">
        ...
        <div class="demo-item">
          <span class="demo-mono">
            <?php echo e($demoPublikUsername); ?> / AdminPublik123
          </span>

          <span class="demo-name">
            <?php echo e($demoPublik?->name ?? 'Admin Publik'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Project\Ruangan_Menara_Wijaya\resources\views/auth/login.blade.php ENDPATH**/ ?>