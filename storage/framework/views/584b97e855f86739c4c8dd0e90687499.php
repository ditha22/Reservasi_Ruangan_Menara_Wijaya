...
<?php $__env->startSection('title', 'Edit OPD'); ?>
...
<div class="container" style="max-width:900px;margin:0 auto;padding:18px 18px 30px;">
  ...
  <div class="table-container" style="margin-top:16px;padding:18px;">
    <form method="POST" action="<?php echo e(route('admin.opd.update', $opd->id)); ?>">
      <?php echo csrf_field(); ?>
      ...
      <div style="display:grid;grid-template-columns:1fr;gap:12px;">
        <div>
          ...
          <input type="text" name="nama" value="<?php echo e(old('nama', $opd->nama)); ?>" required
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
          ...
          <input type="text" name="lantai" value="<?php echo e(old('lantai', $opd->lantai ?? '')); ?>"
                 style="width:100%;margin-top:6px;padding:12px 12px;border:1px solid var(--gray-200);border-radius:12px;">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
          ...
          <input type="text" name="gedung" value="<?php echo e(old('gedung', $opd->gedung ?? '')); ?>"
                 style="width:100%;margin-top:6px;padding:12px 12px;border:1px solid var(--gray-200);border-radius:12px;">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="display:flex;gap:10px;align-items:center;">
          <input type="checkbox" name="is_active" value="1" <?php echo e(old('is_active', $opd->is_active ?? 1) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Project\Ruangan_Menara_Wijaya\resources\views/admin/opd/edit.blade.php ENDPATH**/ ?>