...
<div class="container" style="max-width:1100px;margin:0 auto;padding:18px 18px 30px;">
  ...
  <div class="table-container" style="margin-top:16px;">
    <div class="table-header" style="gap:10px;flex-wrap:wrap;">
      ...
      <form method="GET" action="{{ route('admin.opd.index') }}" style="display:flex;gap:10px;align-items:center;">
        <input type="text" name="q" value="{{ request('q') }}" placeholder="Cari OPD..."
    ...
    <div class="table-responsive">
      <table>
        ...
        <tbody>
          @forelse($opds as $i => $o)
            <tr>
              <td>{{ method_exists($opds,'firstItem') ? ($opds->firstItem() + $i) : ($i+1) }}</td>
